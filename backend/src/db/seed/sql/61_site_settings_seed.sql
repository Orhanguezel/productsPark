...
('07d5dc6d-329c-4ffc-b201-4ca5c7b42a64', 'new_ticket_telegram', 'true', NOW(3), NOW(3)),
...
('0f2ff5df-db32-45a1-a1a1-ebc6a309055b', 'home_featured_title', 'En çok satan ürünlerimize göz atın', NOW(3), NOW(3)),
...
('268e7369-f6cd-41b6-8106-2a61b55191cc', 'facebook_pixel_id', '', NOW(3), NOW(3)),

-- JSON object: currency_rates
...
'<h2>Hesap Satın Al</h2><p>... (uzun HTML içerik) ...</p>',
NOW(3), NOW(3)),
...
('97e7b0da-4d65-47fd-aa26-7897e59fa980', 'home_featured_badge', 'Öne Çıkan Ürünler', NOW(3), NOW(3)),
('98c6835c-67b9-470c-9924-30da6913b0b9', 'smtp_from_email', 'dijital@sosyalpaket.com', NOW(3), NOW(3)),
...
('a0d4bff5-aa59-4233-af47-26db5631ba87', 'smtp_username', 'dijital@sosyalpaket.com', NOW(3), NOW(3)),
...
-- JSON array: home_faq_items
('bde09951-f709-4526-b32a-fa0a25456519', 'home_faq_items',
'[
  {"question":"Ürünler ne kadar sürede teslim edilir?","answer":"Ödemeniz onaylandıktan sonra ürününüz otomatik olarak anında e-posta adresinize ve üye panelinize teslim edilir. Ortalama teslimat süresi 1-2 dakikadır."},
  {"question":"Hangi ödeme yöntemlerini kabul ediyorsunuz?","answer":"Kredi kartı, banka havalesi, Papara, PayTR, Shopier ve kripto para (Coinbase Commerce) ile ödeme yapabilirsiniz. Tüm ödemeler SSL sertifikası ile güvence altındadır."},
  {"question":"Ürün çalışmazsa ne olur?","answer":"Satın aldığınız ürün çalışmaz veya hatalı ise 7 gün içinde destek ekibimizle iletişime geçerek değişim veya iade talebinde bulunabilirsiniz. Tüm ürünlerimiz garanti kapsamındadır."},
  {"question":"Toplu alımlarda indirim var mı?","answer":"Evet! 5+ ürün alımlarında %5, 10+ ürün alımlarında %10 indirim otomatik olarak uygulanır."},
  {"question":"Lisanslar kaç cihazda kullanılabilir?","answer":"Her ürünün kullanım koşulları farklıdır. Ürün detay sayfasında lisans türü ve kaç cihazda kullanılabileceği belirtilmiştir."},
  {"question":"Müşteri desteği nasıl alırım?","answer":"7/24 canlı destek, e-posta, WhatsApp ve Telegram üzerinden bizimle iletişime geçebilirsiniz."}
]',
NOW(3), NOW(3)),

-- JSON object: payment_commission
...
('c8561584-2ebd-40bc-862c-a72bd77072a4', 'smtp_host', 'srvm16.trwww.com', NOW(3), NOW(3)),
...
-- JSON array: available_currencies
...
('f7ee0f74-142b-4018-8e6b-d8ed89f7bd87', 'smtp_password', '{{SMTP_PASSWORD}}', NOW(3), NOW(3)),
