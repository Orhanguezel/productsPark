...
CREATE TABLE IF NOT EXISTS product_faqs (
  ...
  KEY product_faqs_order_idx (display_order)  -- 👈 eklendi
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS product_reviews (
  ...
  KEY product_reviews_approved_idx (product_id, is_active), -- 👈 eklendi
  KEY product_reviews_rating_idx (rating)                   -- 👈 eklendi
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS product_options (
  id            CHAR(36)     NOT NULL,
  product_id    CHAR(36)     NOT NULL,
  option_name   VARCHAR(100) NOT NULL,  -- 👈 TS ile uyumlu
