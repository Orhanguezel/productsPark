  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2"><Label>E‑posta</Label><Input type="email" value={settings.footer_email||""} onChange={(e)=>setSettings((s:any)=>({...s, footer_email:e.target.value}))} /></div>
