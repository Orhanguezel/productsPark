...
// RTK site settings (public) – bulk upsert + prefix list
import {
  useListSiteSettingsQuery,
  useUpsertManySiteSettingsMutation,
  type SiteSetting as SiteSettingDto,
} from "@/integrations/metahub/rtk/endpoints/site_settings.endpoints";

// (İsteğe bağlı) Supabase/Cloudinary storage için mevcut upload mantığını koruyoruz
...
export default function HomeSettings() {
  ...
  // Public list: sadece home_ prefix’i çekiyoruz
  const {
    data: list = [],
    isLoading: isListLoading,
    isFetching: isListFetching,
  } = useListSiteSettingsQuery({ prefix: "home_" });
  ...
  useEffect(() => {
    ...
    for (const row of list) map[row.key] = row.value;

    if (list.length > 0) {
      setSettings((prev) => ({
        ...prev,
        ...defaultSettings,
        ...coerceToShape(defaultSettings, map),
      }));
      hydratedOnce.current = true;
    }
  }, [list]);

  const [upsertMany, { isLoading: isSaving }] =
    useUpsertManySiteSettingsMutation();
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setSettings({
                      ...settings,
                      home_header_top_text: e.target.value,
                    })
                  }
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setSettings({
                      ...settings,
                      home_header_sub_text_1: e.target.value,
                    })
                  }
                  placeholder="Yeni Üyelere Özel"
                />
                <p className="text-xs text-muted-foreground">
                  Hero başlığının ilk satırı (normal yazı)
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setSettings({
                      ...settings,
                      home_header_sub_text_2: e.target.value,
                    })
                  }
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  onChange={(e) =>
                    setSettings({
                      ...settings,
                      home_header_bottom_text: e.target.value,
                    })
                  }
                  rows={3}
                ...
                />
                <p className="text-xs text-muted-foreground">
                  Hero başlığının altında görünen açıklama
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setSettings({
                      ...settings,
                      home_header_button_text: e.target.value,
                    })
                  }
                  placeholder="Ürünleri İncele"
                />
                <p className="text-xs text-muted-foreground">
                  Ana aksiyon butonundaki yazı
                </p>
              </div>
                ...
                <div className="flex items-center gap-2">
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      setSettings({
                        ...settings,
                        home_header_show_contact: checked,
                      })
                    }
                  />
                  <Label htmlFor="show_contact">
                    İletişime Geç Butonu Göster
                  </Label>
                </div>
                <p className="text-xs text-muted-foreground">
              ...
              <div className="space-y-2">
                ...
                {settings.home_hero_image_url && (
                  <div className="mt-2">
                    ...
                    <Button
                      ...
                      className="mt-2"
                      onClick={() =>
                        setSettings({ ...settings, home_hero_image_url: "" })
                      }
                    >
                      Görseli Kaldır
                    </Button>
                ...
                <p className="text-xs text-muted-foreground">
                  Hero bölümünün arka plan görseli. Boş bırakılırsa öne çıkan
                  kategorinin görseli kullanılır.
                </p>
              </div>
              ...
              <div className="space-y-2 p-4 bg-muted/50 rounded-lg">
                ...
                <p className="text-xs text-muted-foreground">
                  Hero bölümünde gösterilen kategori bilgileri,{" "}
                  <strong>Kategoriler</strong> sayfasından "Öne Çıkan" olarak
                  işaretlenen ilk kategori gösterilir. Kategorileri yönetmek
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setSettings({
                      ...settings,
                      home_featured_badge: e.target.value,
                    })
                  }
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setSettings({
                      ...settings,
                      home_featured_title: e.target.value,
                    })
                  }
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setSettings({
                      ...settings,
                      home_featured_button: e.target.value,
                    })
                  }
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setSettings({
                      ...settings,
                      home_how_it_works_title: e.target.value,
                    })
                  }
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setSettings({
                      ...settings,
                      home_how_it_works_subtitle: e.target.value,
                    })
                  }
                ...
                <div key={n} className="border-t pt-4 space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      value={
                        settings[
                          `home_step_${n}_title` as keyof HomeSettings
                        ] as string
                      }
                      onChange={(e) =>
                        setSettings({
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea
                      value={
                        settings[
                          `home_step_${n}_desc` as keyof HomeSettings
                        ] as string
                      }
                      onChange={(e) =>
                        setSettings({
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setSettings({
                      ...settings,
                      home_faq_subtitle: e.target.value,
                    })
                  }
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setSettings({
                        ...settings,
                        home_faq_cta_title: e.target.value,
                      })
                    }
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setSettings({
                        ...settings,
                        home_faq_cta_subtitle: e.target.value,
                      })
                    }
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setSettings({
                        ...settings,
                        home_faq_cta_button: e.target.value,
                      })
                    }
              ...
              <div className="border-t pt-4 space-y-4">
                <div className="flex justify-between items-center">
                  ...
                  <Button
                    ...
                    onClick={() => {
                      const next = [
                        ...(settings.home_faq_items || []),
                        { question: "", answer: "" },
                      ];
                      setSettings({ ...settings, home_faq_items: next });
                    }}
                  >
                    + SSS Ekle
                  </Button>
                  ...
                  <div key={index} className="p-4 border rounded-lg space-y-3">
                    <div className="space-y-2">
                      ...
                      <Input
                        value={faq.question}
                        onChange={(e) => {
                          const next = [...(settings.home_faq_items || [])];
                    ...
                    <Button
                      ...
                      size="sm"
                      onClick={() => {
                        const next = (settings.home_faq_items || []).filter(
                          (_v, i) => i !== index
                        );
                        setSettings({ ...settings, home_faq_items: next });
                      }}
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setSettings({
                      ...settings,
                      home_blog_badge: e.target.value,
                    })
                  }
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setSettings({
                      ...settings,
                      home_blog_title: e.target.value,
                    })
                  }
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setSettings({
                      ...settings,
                      home_blog_subtitle: e.target.value,
                    })
                  }
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setSettings({
                      ...settings,
                      home_blog_button: e.target.value,
                    })
                  }
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center gap-2 pb-1">
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    setSettings({
                      ...settings,
                      home_scroll_content_active: checked,
                    })
                  }
                />
              ...
              <div className="space-y-2">
                ...
                {/* Editör: sabit yükseklik – içerik editör içinde scroll olur */}
                <div className="border rounded-md overflow-hidden">
                  <ReactQuill
                    ...
                    onChange={(value) =>
                      setSettings({
                        ...settings,
                        home_scroll_content: value,
                      })
                    }
                    className="bg-background"
                    theme="snow"
                    // Quill container yüksekliği (scroll editör içinde)
                    style={{ height: 300 }}
                    modules={{
                      toolbar: [
                        [{ header: [1, 2, 3, false] }],
                ...
                {/* Canlı önizleme: max 400px, overflow-auto */}
...
function coerceToShape<T extends Record<string, any>>(
  shape: T,
  ...
  for (const k of Object.keys(shape)) {
    ...
    // Basit tip eşleştirme – default’ın tipine bakıp cast et
    const dv = (shape as any)[k];
    if (Array.isArray(dv)) {
      out[k] = Array.isArray(v) ? v : dv;
    } else if (typeof dv === "boolean") {
      out[k] = typeof v === "boolean" ? v : v === "true";
    } else if (typeof dv === "number") {
      const n = Number(v);
      out[k] = Number.isFinite(n) ? n : dv;
    } else if (typeof dv === "object" && dv !== null) {
      out[k] = typeof v === "object" && v !== null ? v : dv;
    } else {
      out[k] = v ?? dv;
    }
  }
