// =============================================================
// FILE: src/integrations/types/telegram_inbound.ts
// FINAL — Telegram inbound + auto-reply types (FE)
// - exactOptionalPropertyTypes friendly (optional means: if present, not undefined)
// =============================================================
